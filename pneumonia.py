...
train_dir = r"C:\Users\nitik\Downloads\archive (2)\chest_xray\train"
test_dir = r"C:\Users\nitik\Downloads\archive (2)\chest_xray\test"
...
# Streamlit app
def run():
    st.title("Pneumonia Testing")

    st.write("Please upload an image file to test pneumonia")
